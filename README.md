...
Hello! Welcome to my new website! It was build using pure HTML, CSS, and Javascript, because tbh I really didn't want to deal with another static javascript framework for this lmao. Here you'll be able to check out some featured projects and my blog! All the source code is licensed under the MIT license so you can also use this format if you want :).</br>
